...
func handleChecklist(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodGet {
		skills.CurrentChecklistMu.Lock()
		defer skills.CurrentChecklistMu.Unlock()
		if skills.CurrentChecklist == nil {
			json.NewEncoder(w).Encode([]interface{}{})
		} else {
			json.NewEncoder(w).Encode(skills.CurrentChecklist)
		}
		return
	}
	...
	if r.Method == http.MethodPost {
		...
		skills.CurrentChecklistMu.Lock()
		skills.CurrentChecklist = req
		skills.CurrentChecklistMu.Unlock()
