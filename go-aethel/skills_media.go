...
func (s *MediaControlSkill) RiskLevel() RiskLevel { return RiskLow }
...
func (s *MediaControlSkill) Execute(args json.RawMessage) (string, error) {
	...
	if runtime.GOOS == "windows" {
		...
		LogKernelActivity("MEDIA_CONTROL", input.Action, "SUCCESS")
...
func (s *YouTubeControlSkill) RiskLevel() RiskLevel { return RiskLow }
...
func (s *YouTubeControlSkill) Execute(args json.RawMessage) (string, error) {
	...
	LogKernelActivity("YOUTUBE_CONTROL", input.Action, "SUCCESS")
