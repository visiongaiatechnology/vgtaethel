...
var CurrentChecklistMu sync.RWMutex
...
func (s *SetChecklistSkill) RiskLevel() security.RiskLevel { return security.RiskSafe }
...
func (s *UpdateChecklistSkill) RiskLevel() security.RiskLevel { return security.RiskSafe }
